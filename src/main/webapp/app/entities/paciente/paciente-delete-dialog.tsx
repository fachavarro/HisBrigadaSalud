  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="hisBrigadaSaludApp.paciente.delete.question">
          <Translate contentKey="hisBrigadaSaludApp.paciente.delete.question" interpolate={{ id: pacienteEntity.id }}>
