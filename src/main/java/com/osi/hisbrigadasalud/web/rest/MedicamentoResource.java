...
/**
 * REST controller for managing {@link com.osi.hisbrigadasalud.domain.Medicamento}.
 */
@RestController
@RequestMapping("/api")
public class MedicamentoResource {
    ...
    public ResponseEntity<Medicamento> getMedicamento(@PathVariable String id) {
    ...
    public ResponseEntity<Void> deleteMedicamento(@PathVariable String id) {
