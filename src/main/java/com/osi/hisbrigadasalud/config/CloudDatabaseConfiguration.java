package com.osi.hisbrigadasalud.config;
...
@Configuration
@EnableMongoRepositories("com.osi.hisbrigadasalud.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.osi.hisbrigadasalud.config.dbmigrations");
